resource "aws_appautoscaling_target" "ecs" {
  ...
  resource_id        = "service/${var.ecs_name}/${aws_ecs_service.main.name}"
...
resource "aws_appautoscaling_policy" "cpu_high" {
  ...
  name = format("%s-%s-cpu-scale-out", var.ecs_name, var.ecs_service_name)
...
resource "aws_appautoscaling_policy" "cpu_low" {
  ...
  name = format("%s-%s-cpu-scale-in", var.ecs_name, var.ecs_service_name)
...
resource "aws_appautoscaling_policy" "target_tracking_cpu" {
  ...
  name = format("%s-%s-cpu-tracking", var.ecs_name, var.ecs_service_name)
...
resource "aws_appautoscaling_policy" "target_tracking_requests" {
  ...
  name = format("%s-%s-requests-tracking", var.ecs_name, var.ecs_service_name)
