...
variable "alb_listener_https_arn" {
  type        = string
  description = "The ALB HTTPS listener arn"
  default     = null
}
...
variable "deployment_controller" {
  ...
  validation {
    ...
    error_message = "Type of deployment controller can be ECS or CODE_DEPLOY"
  }
}
...
variable "codedeploy_strategy" {
  type        = string
  description = "CodeDeploy deployment strategy"
...
variable "codedeploy_deployment_option" {
  ...
  validation {
    ...
    error_message = "Type of deployment controller can be WITH_TRAFFIC_CONTROL or WITHOUT_TRAFFIC_CONTROL"
  }
}
...
variable "codedeploy_deployment_type" {
  ...
  validation {
    ...
    error_message = "Type of deployment controller can be IN_PLACE or BLUE_GREEN"
  }
}
...
variable "codedeploy_rollback_error_threshold" {
  type        = number
  description = "Defines the percentage error threshold that triggers rollback."
  default     = 10
}

variable "codedeploy_rollback_error_period" {
  type        = number
  description = "Defines the period of time, in seconds, to evaluate the error during rollback."
  default     = 60
}

variable "codedeploy_rollback_error_evaluation_period" {
  type        = number
  description = "Sets the number of evaluation periods before triggering rollback."
  default     = 1
}
